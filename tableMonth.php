...
<div class="col-md-1">
<a button id='circle' class="btn" a href="table.php" data-slide-id="#daily"><br>Daily</a>

<a button id='circle' class="btn" a href="tableWeek.php" data-slide-id="#weekly"><br>Weekly</a>

<a button id='circle' class="btn" a href="#monthly" data-slide-id="#monthly"><br>Monthly</a>

</div>

<div class="col-md-8">
 <div id="monthly" class="slide-div">
  <!-- Table -->
